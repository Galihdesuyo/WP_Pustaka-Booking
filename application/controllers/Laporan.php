...
class Laporan extends CI_Controller
{
    ...
    {
        $data = array('title' => 'Laporan Anggota', 'user' => $this->ModelUser->getUserLimit()->result_array());
        $data['anggota'] = $this->ModelUser->getUserLimit()->result_array();
    ...
    $dompdf->load_html($html);
    $dompdf->render();
    $dompdf->stream("laporan_data_peminjaman.pdf", array('Attachment' => 0)); // nama file pdf yang dihasilkan
    }
